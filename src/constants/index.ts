...
export const WebSearchToolSchema: z.ZodObject<{
  ...
  web_search_preview: z.ZodOptional<
    z.ZodObject<{ search_context_size: z.ZodOptional<z.ZodString> }>
  >;
}> = z.object({
...
export const ComputerCallSchema: z.ZodObject<{
  ...
  computer_use_preview: z.ZodOptional<
    z.ZodObject<{
...
export type ChainStepResponse<T extends StreamType> = T extends 'text' ? ChainStepTextResponse
  : T extends 'object' ? ChainStepObjectResponse
  : never;

export type ChainCallResponseDto<S extends AssertedStreamType = 'text'> = S extends 'text'
  ? ChainStepTextResponse
  : S extends Record<string | symbol, unknown> ? ChainStepObjectResponse<S>
  : never;
