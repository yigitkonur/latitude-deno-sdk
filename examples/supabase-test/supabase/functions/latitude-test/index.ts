            ...
            const result = await latitude.prompts.run('extract-linkedin-from-serp', {
              ...
              parameters: {
                ...
                serp_results: JSON.stringify({
                  organic: [{
                    title: 'Test Engineer - Google',
                    snippet: 'LinkedIn · Test · Google',
          ...
          await runTest('prompts', 'prompts.run() [stream]', async () => {
            ...
            await latitude.prompts.run('extract-linkedin-from-serp', {
              ...
              parameters: {
                ...
                serp_results: JSON.stringify({
                  organic: [{
                    title: 'Stream Test - Meta',
                    snippet: 'LinkedIn · Stream · Meta',
                    link: 'https://linkedin.com/in/stream',
                    position: 1,
                  }],
                }),
              },
            ...
            return {
              ...
              streamDuration: events.length > 1
      ...
      if (action === 'all' || action === 'prompts.run.structured') {
        tests.push(
          await runTest('prompts', 'prompts.run() [structured JSON]', async () => {
            const result = await latitude.prompts.run('extract-linkedin-from-serp', {
              ...
              parameters: {
                ...
                serp_results: JSON.stringify({
                  organic: [
                    {
                      title: 'Alice - Engineer at Apple',
                      snippet: 'LinkedIn · Alice · Apple · San Francisco',
                      link: 'https://linkedin.com/in/alice',
                      position: 1,
                    },
                    {
                      title: 'Bob - Designer at Figma',
                      snippet: 'LinkedIn · Bob · Figma · NYC',
            ...
            const profiles = (result?.response as { object?: unknown })?.object as
              | Array<{ full_name: string; entity_title: string }>
              | undefined;
            return {
          ...
          await runTest('prompts', 'prompts.chat() [conversation]', async () => {
              ...
              parameters: {
                ...
                serp_results: JSON.stringify({
                  organic: [{
                    title: 'Chat Test',
                    snippet: 'Test',
                    link: 'https://linkedin.com/in/chat',
                    position: 1,
                  }],
                }),
              },
            ...
            try {
              ...
              return {
                ...
                chatWorked: false,
                note: 'API limitation for JSON schema prompts',
                sdkWorked: true,
              };
            }
          }),
                  ...
                  organic: [
                    {
                      title: 'Inc1 - Company1',
                      snippet: 'LinkedIn',
                      link: 'https://linkedin.com/in/inc1',
                      position: 1,
                    },
                    {
                      title: 'Inc2 - Company2',
                      snippet: 'LinkedIn',
                      link: 'https://linkedin.com/in/inc2',
                      position: 2,
                    },
                  ],
                }),
        ...
        tests.push(
          await runTest('streaming', 'Stream timing analysis', async () => {
              ...
              parameters: {
                ...
                serp_results: JSON.stringify({
                  organic: [{
                    title: 'Timing - Test',
                    snippet: 'LinkedIn',
                    link: 'https://linkedin.com/in/timing',
                    position: 1,
                  }],
                }),
              },
            ...
            return {
              ...
              avgTimeBetweenEvents: timings.length > 1
                ? `${Math.round(lastEvent / timings.length)}ms`
                : 'N/A',
                  ...
                  organic: [
                    {
                      title: 'Byte1 - Test',
                      snippet: 'LinkedIn',
                      link: 'https://linkedin.com/in/byte1',
                      position: 1,
                    },
                    {
                      title: 'Byte2 - Test',
                      snippet: 'LinkedIn',
                      link: 'https://linkedin.com/in/byte2',
                      position: 2,
                    },
                  ],
                }),
      ...
      if (action === 'all' || action === 'errors.invalidPath') {
        tests.push(
          await runTest('errors', 'Error: invalid prompt path', async () => {
            try {
              await latitude.prompts.run('non-existent-prompt-xyz', {
                stream: false,
                parameters: {},
              });
                ...
                parameters: {
                  ...
                  serp_results: JSON.stringify({
                    organic: [{
                      title: `Test${i}`,
                      snippet: 'LinkedIn',
                      link: `https://linkedin.com/in/p${i}`,
                      position: 1,
                    }],
                  }),
                },
          ...
          await runTest('performance', 'Sequential vs Parallel (3x)', async () => {
            const serp = JSON.stringify({
              organic: [{
                title: 'Perf',
                snippet: 'Test',
                link: 'https://linkedin.com/in/perf',
                position: 1,
              }],
            });
